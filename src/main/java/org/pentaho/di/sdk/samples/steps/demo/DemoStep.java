...
import com.guojin.FastDFSClientUtils;
import com.guojin.FileFromUrl;
...
public class DemoStep extends BaseStep implements StepInterface {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    ...
    String url = data.outputRowMeta.getValueMeta(0).getString(r[0]);
    logBasic("----url="+url);
    ...
    logBasic("======outputRow="+outputRow.length);
    logBasic("======data.outputFieldIndex="+data.outputFieldIndex);
//    logBasic("======outputRow="+(String)outputRow[data.outputFieldIndex]);
    byte[] filestr = FileFromUrl.readFileFromUrl(url, "GET");
    String fileId = FastDFSClientUtils.upload(filestr,"");
    logBasic("======fileId="+fileId);
    outputRow[data.outputFieldIndex] = fileId;
